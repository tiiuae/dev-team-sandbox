...
#
{
  ...
  host = {
    kernelConfig.kernelParams = [
      ...
      "iommu=pt"
      "module_blacklist=i915,xe,snd_pcm,mei_me,simpledrm" # Prevent i915,xe,snd_pcm modules from being accidentally used by host
  ...
  gpu = {
    pciDevices = [
      ...
      # {
      #   # System peripheral [0880]: Intel Corporation Device [8086:7e4c]
      #   # ?
      #   path = "0000:00:08.0";
      #   vendorId = "8086";
      #   productId = "7e4c";
      # }
      # {
      #   # Signal processing controller [1180]: Intel Corporation Device [8086:7d0c] (rev 01)
      #   # intel_vsec
      #   path = "0000:00:0a.0";
      #   vendorId = "8086";
      #   productId = "7d0d";
      # }
      # {
      #   # Processing accelerators [1200]: Intel Corporation Meteor Lake NPU [8086:7d1d] (rev 04)
      #   # intel_vpu
      #   path = "0000:00:0b.0";
      #   vendorId = "8086";
      #   productId = "7d1d";
